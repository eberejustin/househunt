...
export default function GoogleMap({
      ...
      try {
        ...
        const popupContent = `
          <div style="padding: 12px; min-width: 200px; ${apartment.isDeleted ? "opacity: 0.7; background-color: #f9fafb;" : ""}">
            <h4 style="font-weight: 600; font-size: 14px; margin-bottom: 4px; color: ${apartment.isDeleted ? "#6b7280" : "#1f2937"};">
              ${apartment.label}
            </h4>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; font-size: 12px; margin-bottom: 8px;">
              ...
              <span style="color: #6b7280;">
                ${apartment.bedrooms ? `${apartment.bedrooms} BR` : 'N/A'}${apartment.bathrooms ? `/${apartment.bathrooms} BA` : ''}
              </span>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 8px; border-top: 1px solid #e5e7eb;">
              ...
              ${apartment.isFavorited ? '<span style="font-size: 12px; color: #ef4444;">❤️ Favorited</span>' : ''}
            </div>
            ${apartment.isDeleted ? '<p style="font-size: 11px; color: #ef4444; margin-top: 8px; font-style: italic;">This listing has been deleted</p>' : ''}
          </div>
        `;
  ...
  const toggleTransit = () => {
    ...
    toast({
      ...
      description: showTransit ? "Public transit information is now hidden" : "Public transit routes and stops are now visible",
    });
  };
  ...
  const toggleTraffic = () => {
    ...
    toast({
      ...
      description: showTraffic ? "Traffic information is now hidden" : "Live traffic conditions are now visible",
    });
  };
    ...
    <div className="relative flex-1 h-full bg-neutral-100">
      ...
      <div className="absolute top-4 right-4 flex flex-col space-y-2 z-[1000]">
        ...
        <Button 
          ...
          className={`bg-white shadow-lg hover:bg-neutral-50 ${showTraffic ? 'bg-red-50 text-red-600 border-red-200' : ''}`}
